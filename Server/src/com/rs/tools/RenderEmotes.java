...
public class RenderEmotes {
	public static void main(String[] args) throws IOException {
		...
		skip: for (int i = 0; i < Cache.STORE.getIndexes()[2].getLastFileId(32) + 1; i++) {
			...
			/*
			 * RenderAnimDefinitions defs = RenderAnimDefinitions.getRenderAnimDefinitions(i); if (defs.defaultStandAnimation == emoteId
			 * || defs.walkAnimation == emoteId) System.out.println("RenderID: " + i);
			 */
		}
	}
}
