...
public class InterfaceManager {
	...
	public static final int FIXED_SCREEN_COMPONENT_ID = 6;
	public static final int RESIZABLE_SCREEN_COMPONENT_ID = 8;
	public static final int FIXED_INV_COMPONENT_ID = 147;
	public static final int RESIZABLE_INV_COMPONENT_ID = 30;
	private Player player;
	private static final int FIXED_TAB_OFFSET = 152;
	private static final int RESIZABLE_TAB_OFFSET = 33;
	...
	public final class Tab {
		...
		public static final int OBJECTIVES = 8;// also objectives? TODO find
	...
	public void setOverlay(int interfaceId, boolean fullScreen) {
		setWindowInterface(resizableScreen ? fullScreen ? 1 : 8 : 0, interfaceId);
	}

	public void removeOverlay(boolean fullScreen) {
		removeWindowInterface(resizableScreen ? fullScreen ? 1 : 8 : 0);
	}

	public void sendInterface(int interfaceId) {
		setInterface(false, resizableScreen ? RESIZABLE_WINDOW_ID : FIXED_WINDOW_ID, resizableScreen ? RESIZABLE_SCREEN_COMPONENT_ID : FIXED_SCREEN_COMPONENT_ID, interfaceId);
	}
	...
	public void sendOrbs() {
		setWindowInterface(resizableScreen ? 169 : 134, 748);// hp
		setWindowInterface(resizableScreen ? 170 : 136, 749);// pray
		setWindowInterface(resizableScreen ? 171 : 137, 750);// run
		setWindowInterface(resizableScreen ? 172 : 139, 747);// summon
	}

	public void sendChatBox() {
		setWindowInterface(resizableScreen ? 18 : 142, 752);
	}

	public void sendPMChatArea() {
		setWindowInterface(resizableScreen ? 19 : 14, 754);
	}

	public void sendChatOptions() {
		setWindowInterface(resizableScreen ? 15 : 20, 751);
	}

	public void sendLogout() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.LOGOUT : FIXED_TAB_OFFSET + Tab.LOGOUT, 182);
	}

	public void sendQuest() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.QUEST : FIXED_TAB_OFFSET + Tab.QUEST, 190);
	}

	public void sendFriends() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.FRIENDS : FIXED_TAB_OFFSET + Tab.FRIENDS, 550);
	}

	public void sendObjectives() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.OBJECTIVES : FIXED_TAB_OFFSET + Tab.OBJECTIVES, 891);
	}

	public void sendClanChat() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.CLAN : FIXED_TAB_OFFSET + Tab.CLAN, 589);
	}

	public void sendIgnores() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.IGNORES : FIXED_TAB_OFFSET + Tab.IGNORES, 551);
	}

	public void sendMusic() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.MUSIC : FIXED_TAB_OFFSET + Tab.MUSIC, 187);
	}

	public void sendNotes() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.NOTES : FIXED_TAB_OFFSET + Tab.NOTES, 34);
	}

	public void sendEquipment() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.EQUIPMENT : FIXED_TAB_OFFSET + Tab.EQUIPMENT, 387);
	}
	...
	public void sendInventory() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.INVENTORY : FIXED_TAB_OFFSET + Tab.INVENTORY, Inventory.INVENTORY_INTERFACE);
	}
	...
	public void sendCombatStyles() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.ATTACK : FIXED_TAB_OFFSET + Tab.ATTACK, 884);
	}

	public void sendAchievement() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.ACHIEVEMENT : FIXED_TAB_OFFSET + Tab.ACHIEVEMENT, 259);
	}

	public void sendSkills() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.SKILLS : FIXED_TAB_OFFSET + Tab.SKILLS, 320);
	}
	...
	public void sendSettings(int interfaceId) {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.SETTINGS : FIXED_TAB_OFFSET + Tab.SETTINGS, interfaceId);
	}

	public void sendPrayerBook() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.PRAYER : FIXED_TAB_OFFSET + Tab.PRAYER, 271);
	}
	...
	public void sendMagicBook() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.MAGIC : FIXED_TAB_OFFSET + Tab.MAGIC, player.getCombatDefinitions().getSpellBook());
	}

	public void sendSummoningOptions() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + 8 : FIXED_TAB_OFFSET + 8, 880);
	}
	...
	public void sendEmotes() {
		setWindowInterface(resizableScreen ? RESIZABLE_TAB_OFFSET + Tab.EMOTES : FIXED_TAB_OFFSET + Tab.EMOTES, 464);
	}
