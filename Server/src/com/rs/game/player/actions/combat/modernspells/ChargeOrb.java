...
public class ChargeOrb extends Action {
	...
	public boolean checkAll(Player player) {
		if (!hasRunes(player)) {
			player.getSocialManager().sendGameMessage("You don't have required items to charge this orb.");
			return false;
		}
	...
	public int processWithDelay(Player player) {
		...
		if (orb != null) {
			...
			player.getSocialManager().sendGameMessage("You charge the unpowered orb into an "
