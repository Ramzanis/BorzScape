...
public class TzHaarMejKah extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			stage = 0;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "What is this place?", "Who's the current champion?", "What did you call me?", "No I'm fine thanks.");
			break;
		case 0:
			switch (componentId) {
			case OPTION_1:
		...
		case 2:
			stage = 3;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "Are there any rules?", "Ok thanks.");
			break;
		case 3:
			switch (componentId) {
			case OPTION_1:
		...
		case 5:
			stage = 6;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "Do I win anything?", "Sounds good.");
			break;
		case 6:
			switch (componentId) {
			case OPTION_1:
		...
		case 12:
			stage = 13;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "What's a 'JalYt-Ket'?", "I guess so...?", "No I'm not!");
			break;
		case 13:
			switch (componentId) {
			case OPTION_1:
		...
		case 17:
			stage = 18;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "What are you then?", "Thanks for explaining it.");
			break;
		case 18:
			switch (componentId) {
			case OPTION_1:
		...
		case 20:
			stage = 21;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "What other types are there?", "Ah ok then.");
			break;
		case 21:
			stage = 22;
			switch (componentId) {
