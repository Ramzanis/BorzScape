...
public class Man extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			...
			case 0:
				sendNPCDialogue(npcId, 9827, "I can't belive that Lachtopher boy. He tried to borrow", "money from me again.");
				break;
			case 1:
				sendNPCDialogue(npcId, 9827, "Hello, I'm glad to see an adventurar about. There's an", "increase in goblins hanging arround the area.");
				break;
			case 2:
			...
			case 3:
				...
				break;
			case 4:
				sendNPCDialogue(npcId, 9827, "I have to go all the way through the swamp to go mining.", "My poor feet!");
				break;
			case 5:
