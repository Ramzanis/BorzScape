...
public class MrEx extends Dialogue {
	...
	public void start() {
		...
		sendEntityDialogue(SEND_2_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name, "Hello, I can teleport you all around Matrix II,", " would you like to?" }, IS_NPC, npcId, 9827);
	}
