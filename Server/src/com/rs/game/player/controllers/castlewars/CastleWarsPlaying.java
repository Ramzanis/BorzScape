...
public class CastleWarsPlaying extends Controller {
	...
	public void sendInterfaces() {
		player.getInterfaceManager().setOverlay(58, false);
	}
	...
	public boolean processObjectClick1(WorldObject object) {
		...
		if (id == 4406 || id == 4407) {
			...
			return false;
		} else if (id == 36573 || id == 36580) { // toolkit
			player.getInventory().addItem(new Item(4051));
			return false;
		} else if (id == 36574 || id == 36581) { // rock
			player.getInventory().addItem(new Item(4043));
			return false;
		} else if (id == 36576 || id == 36583) { // ropes
			player.getInventory().addItem(new Item(4047));
			return false;
		} else if (id == 36578 || id == 36585) { // pickaxe
			player.getInventory().addItem(new Item(1265));
			return false;
		} else if ((id == 36579 && team == CastleWars.SARADOMIN) || (id == 36586 && team == CastleWars.ZAMORAK)) { // Bandages
			// table
			player.getInventory().addItem(new Item(4049));
			return false;
		} else if (id == 36575 || id == 36582) { // barricades
			player.getInventory().addItem(new Item(4053));
			return false;
		} else if (id == 36577 || id == 36584) { // explosion pots
			...
			if (object.getX() == 2417 && object.getY() == 3075 && object.getPlane() == 0)
			...
			else if (object.getX() == 2417 && object.getY() == 3075 && object.getPlane() == 1)
				player.useStairs(-1, new WorldTile(2417, 3078, 0), 0, 1);
			 ...
			 * else if (id == 4438) player.getActionManager().setSkill(new Mining(object, RockDefinitions.SMALLER_ROCKS)); else if (id ==
			 * 4437) player.getActionManager().setSkill(new Mining(object, RockDefinitions.ROCKS ));
			 */
		else if (id == 4448) {
