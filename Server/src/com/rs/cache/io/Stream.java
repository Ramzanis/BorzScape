...
public abstract class Stream {
	...
	public void decodeXTEA(int keys[], int start, int end) {
		...
		for (int i_56_ = 0; (i_55_ ^ 0xffffffff) < (i_56_ ^ 0xffffffff); i_56_++) {
			...
			while ((i_61_-- ^ 0xffffffff) < -1) {
				i_58_ -= ((i_57_ >>> 5 ^ i_57_ << 4) - -i_57_ ^ keys[~0x439ffffc & i_59_ >>> 11] + i_59_);
				i_59_ -= i_60_;
				i_57_ -= ((i_58_ >>> 5 ^ i_58_ << 4) - -i_58_ ^ i_59_ + keys[i_59_ & 0x3]);
			}
			offset -= 8;
			writeInt(i_57_);
			writeInt(i_58_);
	...
	private final int readInt() {
		offset += 4;
		return ((((Stream) this).buffer[offset - 1] & 0xff) + (~0xffffff & ((Stream) this).buffer[offset - 4] << 24) - (-(0xff0000 & ((Stream) this).buffer[offset - 3] << 16) + -((((Stream) this).buffer[offset - 2] & 0xff) << 8)));
	}
